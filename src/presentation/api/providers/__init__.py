...
def setup_providers(
    ...
    app.dependency_overrides[Stub(Mediator)] = mediator_provider.build  # noqa
    app.dependency_overrides[Stub(CommandMediator)] = mediator_provider.build  # noqa
    app.dependency_overrides[Stub(QueryMediator)] = mediator_provider.build  # noqa
    app.dependency_overrides[Stub(EventMediator)] = mediator_provider.build  # noqa

    state_provider = StateProvider(di_state)

    app.dependency_overrides[get_di_builder] = lambda: di_builder  # noqa
    app.dependency_overrides[get_di_state] = state_provider.build  # noqa
